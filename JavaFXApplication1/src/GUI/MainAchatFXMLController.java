...
public class MainAchatFXMLController implements Initializable {
    ...
    @FXML
    private TableColumn<Achat, String> achat_client_name;
    ...
    public void handleToEdit(ActionEvent e, Achat a) {
        Parent root;
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("EditAchatFXML.fxml"));
            Parent tableViewParent = loader.load();

            Scene tableViewScene = new Scene(tableViewParent);

            //access the controller and call a method
            EditAchatFXMLController controller = loader.getController();
            controller.setA(a);
    ...
    public void initialize(URL url, ResourceBundle rb) {
        achat_client_name.setCellValueFactory(new PropertyValueFactory<>("client_name"));
     ...
     /*   ProductAchatService productAchatService=new ProductAchatService();
        ...
        for(ProductAchat p: productAchatService.displayAll()){
            Product product=productService.findById(p.getProduct());
