...
public class Achat {
    ...
    public String toString() {
        return "Achat{" + "id_achat=" + id_achat.get() +  ", client_name=" + client_name.get() + ", client_type=" + client_type.get() + ", client_address=" + client_address.get() + ", quantite=" + quantite.get() + ", etat=" + etat.get() + ", unite=" + unite.get() + '}';
    }
